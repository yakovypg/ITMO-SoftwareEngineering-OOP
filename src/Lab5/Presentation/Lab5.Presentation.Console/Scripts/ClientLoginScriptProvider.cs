...
public class ClientLoginScriptProvider : IScriptProvider
{
    private readonly IUserService _userService;
    private readonly ICurrentUserService _currentUserService;

    public ClientLoginScriptProvider(IUserService userService, ICurrentUserService currentUserService)
    {
    ...
    public bool TryGetScript([NotNullWhen(true)] out IScript? script)
    {
        ...
        script = new ClientLoginScript(_userService);
        return true;
    }
}
