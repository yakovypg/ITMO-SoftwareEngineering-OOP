...
{
    public CopyFileCommand(string sourcePath, string destinationDirectoryPath, FileSystem? fileSystem = null)
        : base(fileSystem)
    {
    ...
    public override void Execute()
    {
        ...
        FileSystem.FileInteractionProvider.Copy(absoluteSourcePath, absoluteDestinationPath);
    }
}
