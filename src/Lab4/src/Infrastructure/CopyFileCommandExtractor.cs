...
public class CopyFileCommandExtractor : ICommandExtractor
{
    private readonly CopyFileCommandBuilder _builder;

    public CopyFileCommandExtractor(CopyFileCommandBuilder builder)
    {
